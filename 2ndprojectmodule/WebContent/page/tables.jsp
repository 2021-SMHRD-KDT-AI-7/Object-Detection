...
<body class="sb-nav-fixed">
	<%
		t_objectDAO dao = new t_objectDAO();
	ArrayList<t_objectDTO> o_list = new ArrayList<t_objectDTO>();
	o_list = dao.obj_show();
	System.out.println("갯수 확인:" + o_list.size());
	%>
			...
			<div id="layoutSidenav_content">
				<main>
					<div class="container-fluid px-4">
						<h1 class="mt-4">절도 물품 확인</h1>
						<ol class="breadcrumb mb-4">
							<li class="breadcrumb-item"><a href="index.html">전체 간략
									보기</a></li>
							<li class="breadcrumb-item active">절도 물품 확인</li>
						</ol>
						<div class="card mb-4">
