			...
			<div id="layoutSidenav_content">
				<main>
					...
					<div class="container-fluid px-4">
						<h1 class="mt-4">이미지 캡처</h1>
						<ol class="breadcrumb mb-4">
							<li class="breadcrumb-item"><a href="Main.jsp">전체 간략 보기</a></li>
							<li class="breadcrumb-item active">절도행위/얼굴이미지 보기</li>
						</ol>
						<!-- 차트 표1 -->
						<div class="card mb-4">
							<div class="card-header">
								<i class="fas fa-chart-area me-1"></i> 절도 행위 캡처
							</div>
							<!-- 이미지 불러오기 -->
							<div class="imgcen">
						...
						<div class="card mb-4">
							<div class="card-header">
								<i class="fas fa-chart-area me-1"></i> 절도범 얼굴 캡처
							</div>
							<!-- 이미지 불러오기 -->
							<div class="imgcen">
