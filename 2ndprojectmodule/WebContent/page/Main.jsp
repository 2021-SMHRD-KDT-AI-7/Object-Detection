...
<html lang="en">
    ...
    <body class="sb-nav-fixed">
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            <!-- 메인 메뉴바-->
            <a class="navbar-brand ps-3" href="Main.jsp">모델 이름 적는곳</a>
            <!-- 사이드 메뉴바-->
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-3 col-md-6">
                                <div class="card bg-primary text-white mb-4">
                                    ...
                                    <div class="card-footer d-flex align-items-center justify-content-between">
                                        <a class="small text-white stretched-link" href="cctv.jsp">View Details</a>
                            ...
                            <div class="col-xl-3 col-md-6">
                                <div class="card bg-warning text-white mb-4">
                                    ...
                                    <div class="card-footer d-flex align-items-center justify-content-between">
                                        <a class="small text-white stretched-link" href="imgcap.jsp">View Details</a>
                                        <div class="small text-white"><i class="fas fa-angle-right"></i></div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-xl-3 col-md-6">
                                <div class="card bg-success text-white mb-4">
                                    <div class="card-body">절도 물품 확인하기</div>
                                    <div class="card-footer d-flex align-items-center justify-content-between">
                                        <a class="small text-white stretched-link" href="tables.jsp">View Details</a>
                                        <div class="small text-white"><i class="fas fa-angle-right"></i></div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-xl-3 col-md-6">
                                <div class="card bg-danger text-white mb-4">
                                    <div class="card-body">절도범 얼굴 보기</div>
                                    <div class="card-footer d-flex align-items-center justify-content-between">
                                        <a class="small text-white stretched-link" href="imgcap.jsp">View Details</a>
                                        <div class="small text-white"><i class="fas fa-angle-right"></i></div>
                                    </div>
                        ...
                        <div class="row">
                            <div class="col-xl-6">
                                <div class="card mb-4">
                                    ...
                                    <table class="v4">
                                        <tr>
                                        	<td><img class="cctv" src="<%= f_list.get(i).getSituation_img() %>"></td>
                            ...
                            <div class="col-xl-6">
                                <div class="card mb-4">
                                    ...
                                    <table class="v4">
                                        <tr>
                                        	<td><img class="cctv" src="<%= f_list.get(i).getFace_img() %>"></td>
                            ...
                            <div class="card-body">
                                <table id="datatablesSimple">
                                    ...
                                    <tfoot>
                                        <tr>
                                            <th><%= i+1 %></th>
                                            <th><%= o_list.get(i).getItem_name() %></th>
                                            <th><%= o_list.get(i).getItem_cnt() %></th>
                                        </tr>
                                    </tfoot>
                                    <%} %>
                                </table>
